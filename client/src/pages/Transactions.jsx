...
function Transactions() {
  ...
  }, [transactions, search, selectedCategory, typeFilter, cardFilter, sortKey, limit, dateFrom, dateTo]);
    ...
    <div className="p-6 space-y-5 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="text-xs px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 outline-none focus:border-gray-400"
        />
        ...
        {hasDateFilter && (
          <button
            ...
            className="text-xs text-gray-400 hover:text-rose-500 transition-colors whitespace-nowrap"
          >
            초기화
          </button>
        )}
