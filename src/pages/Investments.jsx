...
const initialHoldings = [
  // CMA 계좌
  { id: 1, account: "NH CMA", name: "TIGER 단기채권액티브", code: "272580", qty: 48 },
  { id: 2, account: "NH CMA", name: "우리금융지주", code: "316140", qty: 2 },
  // ISA 계좌
  { id: 3, account: "NH ISA", name: "KODEX 26-12 금융채", code: "0117L0", qty: 560 },
  { id: 4, account: "NH ISA", name: "KODEX 200", code: "069500", qty: 5 },
  { id: 5, account: "NH ISA", name: "TIGER 미국나스닥100", code: "133690", qty: 3 },
  { id: 6, account: "NH ISA", name: "메리츠금융지주", code: "138040", qty: 3 },
  { id: 7, account: "NH ISA", name: "펄어비스", code: "263750", qty: 2 },
  { id: 8, account: "NH ISA", name: "TIGER 미국S&P500", code: "360750", qty: 16 },
  { id: 9, account: "NH ISA", name: "TIGER 미국배당다우존스", code: "458730", qty: 73 },
  { id: 10, account: "NH ISA", name: "KODEX CD금리액티브", code: "459580", qty: 1 },
];
...
function Investments() {
  ...
  const addHolding = () => {
    setHoldings((prev) => [
      ...prev,
      { id: Date.now(), account: "NH ISA", name: "", code: "", qty: 0 }
    ]);
  };
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-gray-950 text-white rounded-2xl p-6 dark:bg-gray-900 dark:border dark:border-gray-800">
        ...
        <p className="text-xs text-gray-500 mt-2">Yahoo Finance 실시간 시세 기준</p>
      </div>
          ...
          <div className="space-y-1">
            {holdings
              ...
              .map((h) => {
                ...
                return (
                  <div key={h.id} className="flex items-center justify-between px-2 py-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">
                          {h.code} · {h.qty}주
                          {currentPrice && ` · 현재가 ${currentPrice.toLocaleString("ko-KR")}원`}
                        </p>
                      </div>
                    </div>
